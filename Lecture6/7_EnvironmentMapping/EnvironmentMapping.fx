...
// Pass 0
//--------------------------------------------------------------//
string NormalMapping_Pass_0_Model : ModelData = "C:\\Program Files (x86)\\AMD\\RenderMonkey 1.82\\Examples\\Media\\Models\\Teapot.3ds";
...
<
   string ResourceName = "C:\\Users\\USER\\Desktop\\ShaderSamples\\05_DiffuseSpecularMapping\\fieldstone_SM.tga";
>;
...
{   
   ...
   float3 ambient = float3(0.1f, 0.1f,0)*albedo;
   return float4(ambient*0.7f + diffuse*0.7f+specular+environment*0.6f,1);
}
